                    ...
                    <div class="card-header">
                        ...
                        <div class="card-body">
                            <form action="{{url('admin/produk/filter')}}" method="post">
                                ...
                                <button class="btn btn-dark float-right bg-info"><i class="fa fa-search"></i>Filter</button>
                            </form>
                        </div>
                    </div>  
                    <div class="card">
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{url('admin/produk', $produk->id)}}" class="btn btn-info"><i class="fa fa-info"></i></a>
